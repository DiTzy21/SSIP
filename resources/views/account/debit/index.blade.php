        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-money-check-alt"></i> MONEY INCOME</h4>
                </div>
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <a href="{{ route('account.debit.create') }}" class="btn btn-primary"
...
<script>
    ...
    swal({
        ...
        if (isConfirm) {
            //ajax delete
            jQuery.ajax({
                url: "{{ route("account.debit.destroy", ":id") }}".replace(':id', id),
                data: 	{
                    "id": id,
                    "_token": token
                },
